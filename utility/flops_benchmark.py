...
def count_flops(model, batch_size, device, dtype, input_size, in_channels, t_model, t_num_classes, t_drop, t_drop_path, t_lka_mode, t_k_size):

    net = model(t_model,
                pretrained=False, 
                num_classes=t_num_classes, 
                drop_rate=t_drop,
                drop_path_rate=t_drop_path,
